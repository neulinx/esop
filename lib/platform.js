...
class Platform extends Sop.Accessor {
  constructor(context) {
    ...
    this.systems = wrapCollection(cols.systems)
    this.actors = wrapCollection(cols.actors)
    this.behaviors = wrapCollection(cols.behaviors)
    this.miscellany = wrapCollection(cols.miscellany)
